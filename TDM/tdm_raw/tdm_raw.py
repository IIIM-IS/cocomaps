...
#     Last Modified       :     [2018-02-14 09:26]
...
def no_value_found_msg():
    ...
    msg.setString("OutputMsg","Unable to comply")
...
def hello_msg():
    ...
    msg = cmsdk2.DataMessage()
    msg.setString("OutputMsg", possible[no])
    return {"Result":"OutMsg", "Text":msg}
...
def go_to_pointA():
    ...
    msg_2.setString("OutputMsg","Sending other to point A")
...
def go_to_pointB():
    ...
    msg_2 = cmsdk2.DataMessage()
    msg_2.setString("OutputMsg","Sending other to point B")
...
def go_to_pointC():
    ...
    msg_2 = cmsdk2.DataMessage()
    msg_2.setString("OutputMsg","Sending other to point C")
...
if __name__ == "__main__":
    ...
    for sentence in t_sentences:
        ...
        if out_msg["Result"] == "OutMsg":
            print "Output msg : {}".format(out_msg["Text"].getString("OutputMsg"))
        elif out_msg["Result"] == "Move":
            print "Output msg : {}".format(out_msg["msg"].getString("PointName"))
